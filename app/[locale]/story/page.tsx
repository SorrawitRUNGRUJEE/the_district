  ...
  return (
    <main className="min-h-screen bg-muted lg:flex lg:flex-col transition-colors duration-300">
      ...
      <div className={`${containerClass} flex flex-wrap pb-20`}>
        ...
        <div className="order-1 lg:w-1/2 w-full min-h-[80vh] bg-[url('/images/story/top.jpg')] bg-cover bg-center" />
        ...
        <div className="order-3 lg:order-4 lg:w-1/2 w-full min-h-[80vh] bg-[url('/images/story/top.jpg')] bg-cover bg-center" />
